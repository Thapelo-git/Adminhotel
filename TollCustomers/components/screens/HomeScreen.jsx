    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff", padding: 10 }}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          >
            <Image
              source={{
                uri: "https://image.shutterstock.com/image-vector/male-avatar-profile-picture-use-600w-193292033.jpg",
              }}
      ...
      >
        ...
        >
          ...
          <View style={{ fontSize: 18, flex: 1, marginLeft: 10 }}>
...
<FlatList
      ...
      <GeoSearch bottomopen={bottomopen} navigation={navigation} setSearchResult={setSearchResult}/>
    </SafeAreaView>
  );
};
